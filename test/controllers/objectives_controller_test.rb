...
class ObjectivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post objectives_url, params: { objective: { created_at: @objective.created_at, deleted_at: @objective.deleted_at, description: @objective.description, ended_on: @objective.ended_on, name: @objective.name, started_on: @objective.started_on, updated_at: @objective.updated_at } }
    end
  ...
  test "should update objective" do
    patch objective_url(@objective), params: { objective: { created_at: @objective.created_at, deleted_at: @objective.deleted_at, description: @objective.description, ended_on: @objective.ended_on, name: @objective.name, started_on: @objective.started_on, updated_at: @objective.updated_at } }
